from hoshizukuri_game.steps.base.honow_step import (
    HonowStep
)
...
class TestHonowStep():
    def test_str(self):
        step = HonowStep(0, 0, 0)
        assert str(step) == "0:honow:0"
    ...
    def test_process_1(self, get_step_classes, is_equal_candidates):
        ...
        assert get_step_classes(next_steps) == [HonowStep]
